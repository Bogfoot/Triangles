...
hidden if the `Triangles_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Triangles_DEVELOPER_MODE` to the configure
...
Runs the executable target `Triangles_exe`.
